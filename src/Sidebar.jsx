                ...
                <ul className="sidebar-list">
                    <div className='sidebar-top'>
                        <NavLink 
                            to="/" 
                            className={({ isActive }) => 
                                isActive ? "sidebar-item sidebar-home active" : "sidebar-item sidebar-home"
                            }
                        >
                            <svg 
                        ...
                        <NavLink 
                            to="/movies" 
                            className={({ isActive }) => 
                                isActive ? "sidebar-item sidebar-movies active" : "sidebar-item sidebar-movies"
                            }
                        >
                            <svg 
                                xmlns="http://www.w3.org/2000/svg" 
                    ...
                    <div className='sidebar-bottom'>
                        <span className="sidebar-item sidebar-settings disabled">
                            <svg 
                                xmlns="http://www.w3.org/2000/svg" 
                                viewBox="0 0 512 512"
                                className='sidebar-icon'
                        ...
                        <span className="sidebar-item sidebar-help disabled">
                            <svg 
                                xmlns="http://www.w3.org/2000/svg" 
                                viewBox="0 0 512 512"
                                className='sidebar-icon'
