        ...
        <div className='master-container'>
            <div className="top-container">
                ...
                <div className="description-box-container">
                    ...
                    <p className='description-information'><span className="description-date description">{movie.Released}</span> . <span className="description-movie-length description">{movie.Runtime}</span> . <span className="description-rating description">{movie.imdbRating}</span></p>
